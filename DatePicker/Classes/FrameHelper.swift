...
class FrameHelper {
    ...
    func centerViewInParent(view: UIView, in parentVC: UIViewController? = nil) {
        ...
        view.centerXAnchor.constraint(equalTo: p.view.centerXAnchor).isActive = true
        view.centerYAnchor.constraint(equalTo: p.view.centerYAnchor).isActive = true
    }
    ...
    func positionCenter(view:UIView, in parentVC: UIViewController, yearless: Bool) {
        ...
        view.centerXAnchor.constraint(equalTo: parentVC.view.centerXAnchor).isActive = true
        view.centerYAnchor.constraint(equalTo: parentVC.view.centerYAnchor).isActive = true
    }
